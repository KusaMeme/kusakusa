...
rm -rf test_bitcoin.coverage/ kusa-gtest.coverage/ total.coverage/
...
clean_exe src/kusa-cli
clean_exe src/kusad
clean_exe src/kusa-gtest
clean_exe src/kusa-tx
clean_exe src/test/test_kusa
clean_exe src/test/test_kusa_fuzzy
...
clean_dep . src/config/kusa-config.h.in
