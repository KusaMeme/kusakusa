...
This mechanism has been integrated into Bitcore-Node-Kusa which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kusachain/insight-api-kusa#web-socket-api](https://github.com/kusachain/insight-api-kusa#web-socket-api)
* API: [https://github.com/kusachain/insight-api-kusa#instantsend-transactions](https://github.com/kusachain/insight-api-kusa#instantsend-transactions)
