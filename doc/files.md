...
* kusa.conf: contains configuration settings for kusad or kusa-qt
* kusad.pid: stores the process id of kusad while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by kusad or kusa-qt
