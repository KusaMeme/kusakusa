Contributing to Kusa Core
============================

The Kusa Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kusachain/kusa/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Kusa Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Kusa
Network Protocol consensus changes.

Whether a pull request is merged into Kusa Core rests with the project merge
...
Patches that change Kusa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kusa consensus, it must have been
...
The review process is normally fairly responsive on the Kusa Core repository, however
...
The project leader is the release manager for each Kusa Core release.
