...
"""Verify that starting kusad with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kusad with -h for help text")
        ...
        self.log.info("Start kusad with -version for version information")
