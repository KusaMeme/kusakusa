...
from test_framework.test_framework import KusaTestFramework
...
class LLMQChainLocksTest(KusaTestFramework):
    def set_test_params(self):
        self.set_kusa_test_params(6, 5, fast_dip3_enforcement=True)
