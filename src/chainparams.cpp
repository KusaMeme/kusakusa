...
{
    const char* pszTimestamp = "When your friend says they'll beat you in Mario Kart... kusa kusa kusa.";
    const CScript genesisOutputScript = CScript() << ParseHex("0481231936e0d11f2121713c6a0c9a4136153e74e30f51d6facce58038ee3c8a82931e0743b29dff72cfaf6f3e8eb5203c02b41a64914077607822cb6c099e2093") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Kusa: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Kusa: 2 minutes
        ...
        //FindMainNetGenesisBlock(1731854451, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1731854451, 801, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6ce0afee9ca1aea57a0aeca5fbf3d6f39b4eecebd8bc4a832f2c26e7d0ca6ae4"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b9eb0ef283744bd9d509a6e3de280911758b59f54447e8cf6bc0a1e5b9bacb8"));

        vFixedSeeds.clear(); 
        vSeeds.clear(); 

        // Kusa addresses start with 'F'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,35);
        // Kusa script addresses start with 'f'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,95);
        // Kusa private keys start with '3'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,18);
        // Kusa BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Kusa BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Kusa BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"FSmVbXhUTKuMCHBKvaRFoB61jSZjDNEzxa"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1731858051,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Kusa: 1 day
        consensus.nPowTargetSpacing = 60; // Kusa: 1 minutes
        ...
        //FindMainNetGenesisBlock(1731861651,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1731861651, 174, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x81afac2af3ddd6f9b96f1a1f25dbce965dee3037600377f338387f3d47b2314f"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b9eb0ef283744bd9d509a6e3de280911758b59f54447e8cf6bc0a1e5b9bacb8"));
        ...
        // Testnet Kusa addresses start with 't'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Kusa script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Kusa BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Kusa BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Kusa BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Kusa: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Kusa: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        nDefaultPort = 19899;
        nPruneAfterHeight = 1000;
        genesis = CreateGenesisBlock(1731868851, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x598c5fff80ed393cb09f62ae8d8083ea869e20a21872d6d40e7aa0ff74876057"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b9eb0ef283744bd9d509a6e3de280911758b59f54447e8cf6bc0a1e5b9bacb8"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("kusaevo.org",  "devnet-seed.kusaevo.org"));

        // Testnet Kusa addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       genesis = CreateGenesisBlock(1731876634, 0, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
printf("REG MERKLE ROOT: %s\n",genesis.hashMerkleRoot.ToString().c_str());
        ...
        // Regtest Kusa addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Kusa script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Kusa BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Kusa BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Kusa BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
