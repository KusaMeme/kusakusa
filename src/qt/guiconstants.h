...
/* KusaGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* KusaGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Kusa"
#define QAPP_ORG_DOMAIN "kusachain.com"
#define QAPP_APP_NAME_DEFAULT "Kusa-Qt"
#define QAPP_APP_NAME_TESTNET "Kusa-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Kusa-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Kusa-Qt-regtest"
