...
/** Utility functions used by the Kusa Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kusa:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load kusa specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a kusa specific theme is activated (light/dark).*/
