...
//! Interface for the src/evo part of a kusa node (kusad process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a kusa node (kusad process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a kusa node (kusad process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a kusa node (kusad process).
class Node
{
public:
    virtual ~Node() {}
